	...
	components:{
		"canvas-clork":{
			...
			<div v-on:click="isShow=!isShow">
				<canvas id="clork" v-bind="{height:size, width:size}" v-show="isShow"></canvas>
				<canvas id="date" v-bind="{height:size, width:size}" v-show="!isShow"></canvas>
			</div>
			`
		}
	},
